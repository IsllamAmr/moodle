...
$numsections = (int)($siteformatoptions['numsections'] ?? 0);
...
if (!empty($CFG->customfrontpageinclude) && is_readable($CFG->customfrontpageinclude)) {
...
} else if (!empty($CFG->customfrontpageinclude)) {
    debugging(
        'Configured custom front page include file is not readable: ' . $CFG->customfrontpageinclude,
        DEBUG_DEVELOPER
    );
    if ($numsections > 0) {
